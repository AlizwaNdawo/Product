    ...
    public partial class frmProducts : frmInheritance
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            if (btnCreate.Text == "Save")
            {
                ...
                {
                    MessageBox.Show("Product Name field cannot be empty", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else if (txtProductDescription.Text == "")
                {
                    MessageBox.Show("Product Description cannot be empty", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else if (txtProductPrice.Text == "")
                {
                    MessageBox.Show("Product Price cannot be empty", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
